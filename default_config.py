...
def get_parser():
    ...
    parser.add_argument('--total_iterations', default=int(12e5), type=int)
    parser.add_argument('--warmup_iterations', default=int(2e5), type=int)
    ...
    parser.add_argument('--e_loss_type', default='mse', type=str, choices=E_LOSS_TYPE)
    parser.add_argument('--v_l2_reg', default=None, type=float)
    parser.add_argument('--lamb_scale', default=1., type=float)
    parser.add_argument('--k_mode', default='to_e', type=str, choices=K_MODE)
    parser.add_argument('--k_max', default = 2.0, type = float)
    parser.add_argument('--k_min', default = 0.5, type = float)
